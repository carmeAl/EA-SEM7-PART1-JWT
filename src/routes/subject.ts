...
import { delete_Subject,get_Subject,get_Subjects,matriculate_Subject,post_Subject, update_Subject,usersIn_Subject } from "../controllers/subject";
...
router.get("/:idSubject/users",usersIn_Subject)
